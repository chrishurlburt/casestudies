...
Route::group(['prefix' => 'admin', 'middleware' => 'auth'], function () {
    ...
    // Route::get('cases/case/{slug}', ['as' => 'admin.studies.edit', 'uses' => 'StudiesController@edit']);
    ...
    // Route::post('cases/case/{slug}', ['as' => 'admin.studies.update', 'uses' => 'StudiesController@update']);
