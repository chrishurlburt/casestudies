...
@section('sectionid', 'manage-cases')


@section('content')

<section id="heading">
    <h3 class="page-title">Manage Case Studies</h3>
...
<section id="published-cases" class="card">
    ...
    <div class="card-header">
        ...
        <a href="{{ route('admin.cases.drafts') }}"><button type="button" class="btn btn-secondary">Manage Drafts</button></a>
        <div class="right">
